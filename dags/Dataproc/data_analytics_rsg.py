...
PROJECT_NAME = "{{var.value.gcp_project_id}}"
...
# Dataproc configs
BUCKET_NAME = "{{var.value.bucket_id}}"
...
with models.DAG(
    "Tutorial_Data_Analytics_RSG",
    # Continue to run DAG once per day
    schedule_interval=datetime.timedelta(days=1),
    default_args=default_dag_args,
    catchup=False,
    tags=["Regional Services Group", "BigQuery", "Google Cloud Storage", "Dataproc"],
    ...
    with TaskGroup("join_bq_datasets") as bq_join_group:
        for year in range(2017, 2022):
            ...
            FROM `stellar-chariot-224523.holiday_weather.holidays` AS Holidays
