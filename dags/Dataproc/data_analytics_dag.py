...
PROJECT_NAME = "{{var.value.gcp_project_id_1}}"
...
# Dataproc configs
BUCKET_NAME = "{{var.value.bucket_id_1}}"
...
with models.DAG(
    ...
    with TaskGroup("join_bq_datasets") as bq_join_group:
        for year in range(1997, 2022):
            ...
            FROM `proyecto-fabio-tafur-datos.holiday_weather.holidays` AS Holidays
